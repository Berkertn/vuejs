<template>
    <div class="flex flex-1 flex-col items-center">
        <!-- Banner -->
        <div v-if="route.query.preview" class="text-white bg-weather-secondary p-4 w-full text-center">
            <p>You're currently previewing this city, click "+" icon to start tracking this city.</p>
        </div>
